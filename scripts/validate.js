...
const routineSelfTests = [
  ...
  'agent-phase19-2a:self-test',
  'agent-execution:self-test',
  'agent-runtime-containment:self-test',
  'agent-operations-ui:self-test',
  ...
  'dev-commit-tool-contract:self-test',
  ...
  'browser-observability:self-test',
  ...
  'supervisor-grant:self-test',
  'supervisor-lifecycle-auth:self-test',
  'supervisor-runtime-ui:self-test',
  'supervisor:auto-start:self-test',
