...
function ManageAgents() {
  ...
  return (
    <>
      ...
      {canPreview && <Panel className="mt-3" title="Advisory authority preview · complete policy display" subtitle="Policy-effective authority is shown separately from Phase 19.2C bounded fake-runtime, durable interaction, and managed Browser capability admission. This advisory preview cannot start a run; real providers, unapproved or generic capability effects, scheduler execution, delegation and child Agents, writable development workspaces, and external Agent execution remain disabled.">
