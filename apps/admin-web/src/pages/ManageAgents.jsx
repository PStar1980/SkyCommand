...
function ManageAgents() {
  ...
  return (
    <>
      ...
      {canRuntimeManage && <Panel className="mt-3" title="Runtime, account, and capability registration" subtitle="These records define the controlled source-backed fake-runtime entitlement and policy boundary. Real-provider and capability execution remains disabled.">
      ...
      {canPreview && <Panel className="mt-3" title="Advisory authority preview · complete policy display" subtitle="Policy-effective authority is shown separately from Phase 19.2A fake-runtime admission. This advisory preview cannot start a run; real providers, capability effects, scheduler execution, delegation, writable development workspaces, and external Agent execution remain disabled.">
