...
function ManageAgents() {
  ...
  return (
    <>
      ...
      {canPreview && <Panel className="mt-3" title="Advisory authority preview · complete policy display" subtitle="Policy-effective authority is shown separately from the Phase 19.2B bounded fake-runtime and managed Browser capability admission. This advisory preview cannot start a run; real providers, generic/unapproved capability effects, scheduler execution, delegation, writable development workspaces, and external Agent execution remain disabled.">
