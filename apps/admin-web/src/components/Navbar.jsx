...
const COMMAND_SEARCH_ALIASES = {
  ...
  'playwright automation': '/browser-automations/run',
  'browser automation': '/browser-automations/run',
  'run playwright automation': '/browser-automations/run',
  'run browser automation': '/browser-automations/run',
  'automation operations': '/browser-automations/operations',
  'manage playwright automation': '/browser-automations/manage',
  'manage browser automation': '/browser-automations/manage',
  'add playwright automation': '/browser-automations/add',
  'add browser automation': '/browser-automations/add',
  'automation registry': '/browser-automations/manage',
      ...
      items: [
        {
          ...
          to: '/browser-automations/operations',
          icon: '↺',
          visible: hasPermission('BROWSER_AUTOMATION_READ'),
          description: 'Operational browser execution ledger',
        },
        {
          label: 'Run Automations',
          to: '/browser-automations/run',
          icon: '▶',
          visible: hasPermission('BROWSER_AUTOMATION_RUN'),
          description: 'Launch registered Playwright automations',
        },
        {
          label: 'Manage Automations',
          to: '/browser-automations/manage',
          icon: '▧',
          visible: hasPermission('ADMIN_BROWSER_AUTOMATION_READ'),
          description: 'Playwright Automation registry',
        },
        {
          label: 'Add Automation',
          to: '/browser-automations/add',
          icon: '+',
          visible: hasPermission('ADMIN_BROWSER_AUTOMATION_WRITE'),
          description: 'Register operational Playwright source',
        },
      ],
    },
    {
