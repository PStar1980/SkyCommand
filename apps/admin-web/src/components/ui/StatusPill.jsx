const SUCCESS_STATUSES = new Set(['SUCCESS', 'CURRENT', 'ONLINE', 'POLLING', 'COMPLETED', 'PASS', 'ACTIVE', 'READY', 'VALID', 'HEALTHY']);
const DANGER_STATUSES = new Set(['FAILED', 'FAIL', 'ERROR', 'OFFLINE', 'TERMINATED', 'CANCELED', 'BLOCKED', 'INVALID', 'REJECTED', 'UNHEALTHY']);
