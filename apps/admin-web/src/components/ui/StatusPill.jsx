const SUCCESS_STATUSES = new Set(['SUCCESS', 'CURRENT', 'ONLINE', 'POLLING', 'COMPLETED', 'PASS', 'PASSED', 'ACTIVE', 'READY', 'VALID', 'HEALTHY']);
const DANGER_STATUSES = new Set(['FAILED', 'FAIL', 'ERROR', 'OFFLINE', 'TERMINATED', 'CANCELED', 'BLOCKED', 'INVALID', 'REJECTED', 'UNHEALTHY', 'TIMED_OUT']);
const WARNING_STATUSES = new Set(['STARTED', 'RUNNING', 'WARNING', 'STALE', 'DEGRADED', 'BUSY', 'QUEUED', 'PENDING', 'DISABLED', 'STOPPED', 'PARTIAL', 'PAUSED', 'RESTARTING']);
