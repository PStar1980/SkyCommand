...
assert.strictEqual(
  shouldTrackApiRequest({ path: '/api/infrastructure/providers/docker/telemetry/ingest' }),
  false,
);
assert.strictEqual(
  shouldTrackApiRequest({ path: '/api/infrastructure/providers/docker/telemetry/stream' }),
  false,
);
