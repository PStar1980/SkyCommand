            ...
            params: [
              {
                ...
                label: 'Database 1',
                type: 'string',
                prompt: 'Optional first PostgreSQL database name. Leave blank to use PGDATABASE.',
                required: false,
                defaultValue: null,
                displayOrder: 10,
                enabled: true,
              ...
              },
              {
                ...
                label: 'Database 2',
                type: 'string',
                prompt: 'Optional second PostgreSQL database name.',
                required: false,
                defaultValue: null,
                displayOrder: 20,
                enabled: true,
            ...
            params: [
              {
                ...
                label: 'Database Name',
                type: 'string',
                prompt: 'Enter the target PostgreSQL database name.',
                required: true,
                defaultValue: null,
                displayOrder: 10,
                enabled: true,
