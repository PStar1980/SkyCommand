...
WITH core_app AS (
  ...
  SELECT
    ...
    'Scheduler bridge that starts an approved SkyServer workflow definition through the Temporal-backed workflow executor.',
    ...
    'medium',
    TRUE,
    'This schedule will start an approved SkyServer workflow through the Temporal-backed executor. Confirm only when the workflow, timing, and input JSON are intentional.',
    TRUE,
    TRUE,
    20,
    TRUE
