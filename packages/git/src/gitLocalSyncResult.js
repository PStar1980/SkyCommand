...
function createGitLocalSyncToolResult(result = {}) {
  ...
  return validateToolResult({
    ...
    output: {
      ...
      trackingMainBeforeSha: nullable(result.trackingMainBeforeSha),
      trackingDevBeforeSha: nullable(result.trackingDevBeforeSha),
      ...
      trackingMainAfterSha: nullable(result.trackingMainAfterSha),
      trackingDevAfterSha: nullable(result.trackingDevAfterSha),
      ...
      trackingRefsSynchronized: Boolean(result.trackingRefsSynchronized),
