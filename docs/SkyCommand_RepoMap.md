...
├── docker/
│   ├── agent-runtime-worker.Dockerfile
│   ├── agent-runtime-worker.package.json
│   ├── api.Dockerfile
│   ├── api.package.json
...
└── tests/
    ...
    └── self/
        ...
        └── scripts/
            ├── docker/
            │   ├── agentRuntimeWorkerContainmentSelfTest.js
