...
| 4. Truthful observability                                   | Event/result schemas; security/observability decisions; unknown-value fixtures    | Phases 1–2 telemetry                   |
...
| 7. Formal effective authority                               | Authority snapshot and API authorization matrix                                   | Phases 1–2 policy tests                |
