...
const workflowParameterUtilsTest = read(
  'tests/self/apps/api/src/services/workflowParameterUtilsSelfTest.js',
);
...
const workflowConditionTest = read(
  'tests/self/apps/api/src/services/workflowConditionSelfTest.js',
);
assert(
...
const workflowVisibilityTest = read(
  'tests/self/apps/api/src/services/workflowToolVisibilitySelfTest.js',
);
assert(
...
const confirmationTest = read(
  'tests/self/apps/api/src/services/workflowToolConfirmationPolicySelfTest.js',
);
assert(
...
const outputTest = read('tests/self/apps/admin-web/src/pages/workflowDatabaseOutputSelfTest.js');
