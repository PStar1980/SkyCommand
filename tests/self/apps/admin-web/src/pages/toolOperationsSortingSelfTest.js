...
const pageSource = fs.readFileSync(path.join(sourceDir, 'ScriptExecutions.jsx'), 'utf8');
const cssSource = fs.readFileSync(path.join(sourceDir, '..', 'App.css'), 'utf8');
const adminReadServiceSource = fs.readFileSync(
  path.join(sourceDir, '..', '..', '..', 'api', 'src', 'services', 'adminReadService.js'),
  'utf8',
);
const sortUtilitySource = fs.readFileSync(
  path.join(sourceDir, '..', '..', '..', 'api', 'src', 'services', 'tableSortUtils.js'),
  'utf8',
);
