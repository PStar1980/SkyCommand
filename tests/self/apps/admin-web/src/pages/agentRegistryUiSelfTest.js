...
assert.match(projects, /Controlled source-backed fake runtime execution, durable approval and user-input interactions, and the bounded managed Browser Automation pilot are enabled in Phase 19\.2C/);
...
assert.match(agents, /Controlled source-backed fake runtime execution, durable approval and user-input interactions, and the bounded managed Browser Automation pilot are enabled in Phase 19\.2C/);
...
console.log('✅ Phase 19.2C Admin-Web registry surface self-test passed.');
