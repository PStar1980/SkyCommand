...
assert.match(projects, /Controlled source-backed fake runtime execution and one bounded managed Browser Automation capability are enabled in Phase 19\.2B/);
...
assert.match(agents, /Controlled source-backed fake runtime execution and one bounded managed Browser Automation capability are enabled in Phase 19\.2B/);
...
console.log('✅ Phase 19.2B Admin-Web registry surface self-test passed.');
