...
const managerSource = fs.readFileSync(path.join(sourceDir, 'WorkflowManager.jsx'), 'utf8');
const builderSource = fs.readFileSync(path.join(sourceDir, 'WorkflowBuilder.jsx'), 'utf8');
const manageToolsSource = fs.readFileSync(path.join(sourceDir, 'ManageTools.jsx'), 'utf8');
