...
const cssPath = path.join(sourceDir, '..', '..', 'App.css');
const indexCssPath = path.join(sourceDir, '..', '..', 'index.css');
const chartThemePath = path.join(sourceDir, '..', 'charts', 'chartTheme.js');
const dashboardVisualsPath = path.join(sourceDir, '..', 'charts', 'DashboardVisuals.jsx');
const loginPath = path.join(sourceDir, '..', '..', 'pages', 'Login.jsx');
