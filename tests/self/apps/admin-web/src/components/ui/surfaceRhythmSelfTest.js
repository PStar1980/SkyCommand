...
const dashboardFilterSource = fs.readFileSync(path.join(sourceDir, 'DashboardFilterCard.jsx'), 'utf8');
const dockerOverviewSource = fs.readFileSync(
  path.join(sourceDir, '..', '..', 'pages', 'DockerOverview.jsx'),
  'utf8',
);
const commandCenterSource = fs.readFileSync(
  path.join(sourceDir, '..', '..', 'pages', 'Dashboard.jsx'),
  'utf8',
);
