...
const dockerIntegration = read('tests/self/scripts/docker/dockerIntegrationSelfTest.js');
...
assert(
  validate.includes("'docker-integration:self-test'") &&
    dockerIntegration.includes('tests/self/scripts/docker/webDockerSelfTest.js'),
